...
// Apenas specs verídicas (sem descricao). Mais barato que enrichVehicleWithSearch.
export async function fetchVehicleSpecs(
  claudeKey: string,
  v: Pick<VehicleEnrichmentInput, "marca" | "modelo" | "versao" | "ano_fabricacao" | "ano_modelo" | "cambio" | "combustivel">,
