...
const InventoryListPage1 = lazy(() =>
  import("./pages/car-listings/inventory-list-01")
);
const InventorySinglePage1 = lazy(() =>
  import("./pages/car-singles/inventory-page-single-v1")
);
...
const LoanCalculatorPage = lazy(() =>
  import("./pages/otherPages/loan-calculator")
);
...
const FinanciamentoContent = lazy(() =>
  import("./components/financiamento/FinanciamentoContent")
);
const EstoqueTestePage = lazy(() =>
  import("./pages/estoque/EstoqueTestePage")
);
...
const DashboardPage = lazy(() =>
  import("./pages/_interno/area-cliente/dashboard")
);
const MyListingsPage = lazy(() =>
  import("./pages/_interno/area-cliente/my-listings")
);
const AddListingsPage = lazy(() =>
  import("./pages/_interno/area-cliente/add-listings")
);
const SavedPage = lazy(() => import("./pages/_interno/area-cliente/saved"));
const MessagesPage = lazy(() =>
  import("./pages/_interno/area-cliente/messages")
);
const ProfilePage = lazy(() =>
  import("./pages/_interno/area-cliente/profile")
);
const UIElementsPage = lazy(() =>
  import("./pages/_interno/elementos-interface")
);
...
const CredereAuthExplainer = lazy(() =>
  import("./pages/others/CredereAuthExplainer")
);
const CredereSolutionGuide = lazy(() =>
  import("./pages/others/CredereSolutionGuide")
);
const CredereSetupHelper = lazy(() =>
  import("./pages/others/CredereSetupHelper")
);
const CredereFinalSolution = lazy(() =>
  import("./pages/others/CredereFinalSolution")
);
const CrederePluginSolution = lazy(() =>
              ...
              <Suspense fallback={<LoadingSpinner />}>
                <Routes>
                  ...
                  <Route path="/estoque" element={<EstoqueLayout />}>
                    ...
                    <Route path=":identifier" element={<InventorySinglePage1 />} />
                  </Route>
                  ...
                  {/* COMPATIBILIDADE */}
                  <Route path="/inventory-list-01" element={<InventoryListPage1 />} />
                  <Route path="/veiculo/:identifier" element={<InventorySinglePage1 />} />
                  <Route path="/veiculo-individual/:identifier" element={<InventorySinglePage1 />} />
