                ...
                <div className="col-xl-3 col-lg-12" key={index}>
                  <div className="uii-item">
                    ...
                    <div className={`ui-icon ${item.iconClass}`}>
                      <img fetchpriority="low" decoding="async" loading="lazy" alt={item.label} width={item.imgWidth} height={item.imgHeight} src={item.imgSrc} />
                    </div>
                  </div>
                </div>
              ))}
                  ...
                  <div className="notification-widget ls-widget">
                    ...
                    <div className="widget-content">
                      <ul className="notification-list">
                        <li>
                          <span className="icon">
                            <img fetchpriority="low" decoding="async" loading="lazy" alt="" width={20} height={20} src="/images/icons/lob1.svg" />
                          </span>
                        ...
                        <li>
                          <span className="icon">
                            <img fetchpriority="low" decoding="async" loading="lazy" alt="" width={18} height={18} src="/images/icons/lob2.svg" />
                          </span>
                        ...
                        <li className="success">
                          <span className="icon">
                            <img fetchpriority="low" decoding="async" loading="lazy" alt="" width={16} height={16} src="/images/icons/lob3.svg" />
                          </span>
