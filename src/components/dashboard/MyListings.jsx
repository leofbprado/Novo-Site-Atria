                      ...
                      <tr key={index}>
                        <td>
                          <div className="shop-cart-product">
                            <div className="shop-product-cart-img">
                              <img fetchpriority="low" decoding="async" loading="lazy" alt={item.productName} src={item.productImage} width={120} height={105} />
                            </div>
                        ...
                        <td>
                          <a href="#" className="remove-cart-item">
                            <img fetchpriority="low" decoding="async" loading="lazy" alt="Remove item" src={item.removeIcon} width={18} height={18} />
                          </a>
                          <a href="#" className="remove-cart-item">
                            <img fetchpriority="low" decoding="async" loading="lazy" alt="Edit item" src={item.editIcon} width={18} height={18} />
                          </a>
                        </td>
                      </tr>
                    ))}
