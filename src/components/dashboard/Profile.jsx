                  ...
                  <div className="inner-box add-input-image">
                    {images.map((imgSrc, index) => (
                      <div className="image-box" key={index}>
                        <img fetchpriority="low" decoding="async" loading="lazy" width={190} height={167} src={imgSrc} alt={`Preview ${index}`} className="uploaded-img" />
                        <div className="content-box">
                          <ul className="social-icon">
                            <li>
                              <a onClick={() => handleDelete(index)}>
                                <img fetchpriority="low" decoding="async" loading="lazy" width={18} height={18} src="/images/resource/delet.svg" alt="" />
                              </a>
                            </li>
                            <li>
                              ...
                              <label htmlFor={`file-upload-${index}`}>
                                <a>
                                  <img fetchpriority="low" decoding="async" loading="lazy" width={18} height={18} src="/images/resource/delet1-1.svg" alt="Upload" />
                                </a>
                              </label>
                              <input
                    ...
                    <div className="uplode-box">
                      <div className="content-box">
                        <label htmlFor="upload-new">
                          <img fetchpriority="low" decoding="async" loading="lazy" width={34} height={34} src="/images/resource/uplode.svg" alt="Upload" />
                          <span>Upload</span>
                        </label>
                        <input
                          id="upload-new"
                ...
                <div className="gallery-box">
                  <div className="inner-box">
                    {images2.map((imgSrc, index) => (
                      <div className="image-box" key={index}>
                        <img fetchpriority="low" decoding="async" loading="lazy" width={190} height={167} src={imgSrc} alt={`Preview ${index}`} />
                        <div className="content-box">
                          <ul className="social-icon">
                            <li>
                  ...
                  <form onSubmit={(e) => e.preventDefault()} className="row">
                    ...
                    <div className="form-submit">
                      <button type="submit" className="theme-btn">
                        Save Profile
                        <img fetchpriority="low" decoding="async" loading="lazy" alt="" src="/images/arrow.svg" width={14} height={14} />
                      </button>
                    </div>
                  </form>
                </div>
