...
export default function Header3() {
  ...
  return (
    <>
      <style>{`
        .boxcar-header.hheader-style-v4.v6 {
          background-color: #1a2332 !important;
        }
        .boxcar-header.hheader-style-v4.v6 * {
          color: #ffffff !important;
        }
        .boxcar-header.hheader-style-v4.v6 a {
          color: #ffffff !important;
          text-decoration: none !important;
        }
        .boxcar-header.hheader-style-v4.v6 a:hover {
          color: #e2e8f0 !important;
        }
      `}</style>
      <header className="boxcar-header hheader-style-v4 v6" style={{ backgroundColor: '#1a2332' }}>
          ...
          <div className="c-box">
            <div className="nav-list">
              <div className="logo-inner">
                <div className="logo">
                  <Link to={`/home-2`}>
                    <img fetchpriority="high" decoding="async" loading="eager" alt="" title="Boxcar" src="/images/logo2.svg" width={108} height={26} />
                  </Link>
                </div>
              </div>
              {/*Nav Box*/}
