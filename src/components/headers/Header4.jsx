...
export default function Header4() {
  ...
  return (
    <>
      <style>{`
        .boxcar-header.header-style-v7 {
          background-color: #1a2332 !important;
        }
        .boxcar-header.header-style-v7 * {
          color: #ffffff !important;
        }
        .boxcar-header.header-style-v7 a {
          color: #ffffff !important;
          text-decoration: none !important;
        }
        .boxcar-header.header-style-v7 a:hover {
          color: #e2e8f0 !important;
        }
      `}</style>
      <header className="boxcar-header header-style-v7" style={{ backgroundColor: '#1a2332' }}>
