        ...
        <div className="inner-container">
          ...
          <div className="c-box">
            <div className="logo-inner">
              <div className="logo">
                <Link to={`/`}>
                  <img fetchpriority="high" decoding="async" loading="eager" alt="" title="Átria Veículos" width="120" height="40" src="https://res.cloudinary.com/dyngqkiyl/image/upload/f_avif,q_auto,w_120,h_40,c_fit/v1754490506/brands/atria-logo.avif" />
                </Link>
              </div>
            ...
            <div className="right-box">
              <a href="#" className="haeder-img">
                <img fetchpriority="high" decoding="async" loading="eager" width={50} height={50} src="/images/resource/header-img.png" alt="" />
              </a>
