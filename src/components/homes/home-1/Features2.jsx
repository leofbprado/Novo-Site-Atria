    ...
    <section className="why-choose-us-section">
      <div className="boxcar-container">
        <div className="boxcar-title wow fadeInUp">
          <h2 className="title">O que tem nos vídeos?</h2>
        </div>
        <div className="row">
          {/* choose-us-block */}
          <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp">
              ...
              <div className="content-box">
                <h6 className="title">Conteúdo Exclusivo</h6>
                <div className="text">
                  Oportunidades que você não encontra no estoque normal
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="100ms">
              ...
              <div className="content-box">
                <h6 className="title">Ofertas Relâmpago</h6>
                <div className="text">
                  7 dias de validade - viu, gostou, garantiu!
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="200ms">
              ...
              <div className="content-box">
                <h6 className="title">Tour Virtual</h6>
                <div className="text">
                  Conheça o carro em detalhes sem sair de casa
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="300ms">
              ...
              <div className="content-box">
                <h6 className="title">Preço de Lançamento</h6>
                <div className="text">
                  Desconto especial para quem vem pelo vídeo
                </div>
              </div>
            </div>
          </div>
