            ...
            <div className="inner-box wow fadeInUp">
              <div className="hover-img">
                <figure className="image">
                  <a href="#">
                    <img fetchpriority="low" decoding="async" loading="lazy" alt="" src="/images/resource/blog3-1.jpg" width={686} height={396} />
                  </a>
                </figure>
          ...
          <div className="blog-blockt-three home9 col-lg-6 col-md-6 col-sm-12">
            <div className="inner-box two wow fadeInUp" data-wow-delay="100ms">
              <div className="hover-img">
                <figure className="image">
                  <a href="#">
                    <img fetchpriority="low" decoding="async" loading="lazy" alt="" src="/images/resource/blog3-2.jpg" width={686} height={396} />
                  </a>
                </figure>
                <div className="content-box">
                  <h3 className="title">
