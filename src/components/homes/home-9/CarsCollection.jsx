            ...
            <div className="inner-column">
              <div className="image-box">
                <figure className="image">
                  <a href="#">
                    <img fetchpriority="low" decoding="async" loading="lazy" alt="" src="/images/resource/pricing9-1.jpg" width={285} height={279} />
                  </a>
                </figure>
                <figure className="image-2">
                  <a href="#">
                    <img fetchpriority="low" decoding="async" loading="lazy" alt="" src="/images/resource/pricing9-2.jpg" width={224} height={224} />
                  </a>
                </figure>
              </div>
              <div className="image-box">
                <figure className="image-3">
                  <a href="#">
                    <img fetchpriority="low" decoding="async" loading="lazy" alt="" src="/images/resource/pricing9-3.jpg" width={336} height={447} />
                  </a>
                </figure>
              </div>
            </div>
