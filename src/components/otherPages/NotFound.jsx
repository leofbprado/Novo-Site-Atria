      ...
      <div className="boxcar-container">
        <div className="right-box">
          <div className="image-box">
            <img fetchpriority="low" decoding="async" loading="lazy" className="error-logo-404" src="/images/logos/logo.png" alt="Átria Veículos" />
            <div className="content-box">
              <h2>Ops! Página não encontrada.</h2>
              <div className="text">
                A página que você procura não está disponível. 
                Volte para o nosso estoque e continue navegando.
              </div>
              <Link to={`/estoque`} className="error-btn">
