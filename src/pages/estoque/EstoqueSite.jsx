      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <img height="60" width="150" fetchpriority="low" decoding="async" loading="lazy" src="/images/logos/logo-white.png" alt="Átria Veículos" style={{ height: '40px', marginRight: '15px', imageRendering: '-webkit-optimize-contrast', msInterpolationMode: 'nearest-neighbor' }} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                {urlBrand ? `Confira todos os veículos da marca ${urlBrand} disponíveis` : 'Encontre o veículo perfeito para você'}
              </p>
